...
I conducted all analyses using R Version 4.2.0 [@rcoreteam2022] within R Studio Version 2022.2.2.485 [@rstudioteam2022]. The thesis was entirely written in Quarto Version 0.9.380 [@allaire2022a]. The attached packages and default settings are documented in @sec-tech.
