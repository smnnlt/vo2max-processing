...
![Respiratory Rates peak around 60 min^-1^ in the ramp tests. The red segments correspond to the last minute before exhaustion of each individual (n = 72).](../plots/rr.png){#fig-rr}
