...
The calculation intervals for time-based averages of mixing chamber and breath-by-breath devices ranged from 5 to 60 seconds (see @fig-duration). 30-second intervals were most common to define V̇O~2max~, while some authors also often employed shorter (10-20 s) and longer (60 s) periods.

```{r}
#| echo: false
#| fig-cap: "Total durations of the calculation interval of V̇O~2max~ in the reviewed studies. ROBERT SCHLÄGT VOR HIER LIEBER EINE TABELLE ZU NEHMEN. ICH BIN FÜR DIE GRAFIK. WAS MEINST DU?."
#| label: fig-duration
#| out-width: '90%'
