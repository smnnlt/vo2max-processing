...
```{r}
#| echo: false
#| fig-cap: "Total durations of the calculation interval of V̇O~2max~ in the reviewed studies. STILL UP TO DEBATE WHETHER RATHER PLOT (VERTICAL OR HORIZONTAL BARS?) OR TABLE."
#| label: fig-duration
#| out-width: '90%'
...
DISCUSS IF WE SHOULD CHANGE THE ORDER OF RECOMMENDATIONS/GUIDELINES AND LIMITATIONS.
