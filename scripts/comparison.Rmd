...
## Plot data: Comparison of processing strategies

```{r}
# Function for calculating quantils
...
ggsave(filename = "../plots/example.png", width = 6, height = 4, dpi = 1200, bg = "white")
```
